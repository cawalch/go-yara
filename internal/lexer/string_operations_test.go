	...
	tests := []tokenTestCase{
		{
			...
			expected: []token.Token{
				...
				{Type: token.StringLit, Literal: ".text"},
		...
		},
		{
			...
			expected: []token.Token{
				...
				{Type: token.CONTAINS, Literal: "contains"},
				{Type: token.StringLit, Literal: "malware"},
				{Type: token.EOF, Literal: ""},
			},
		},
		{
			...
			expected: []token.Token{
				...
				{Type: token.LBRACKET, Literal: "["},
				{Type: token.StringLit, Literal: "CompanyName"},
				{Type: token.RBRACKET, Literal: "]"},
				{Type: token.ICONTAINS, Literal: "icontains"},
				{Type: token.StringLit, Literal: "microsoft"},
				{Type: token.EOF, Literal: ""},
			},
		},
	}
	...
	tests := []tokenTestCase{
		{
			...
			expected: []token.Token{
				...
				{Type: token.StringLit, Literal: "MZ"},
				{Type: token.EOF, Literal: ""},
			},
		},
		{
		...
		},
		{
			...
			expected: []token.Token{
				...
				{Type: token.StringLit, Literal: ".exe"},
				{Type: token.EOF, Literal: ""},
			},
		},
		{
	...
	tests := []tokenTestCase{
		{
			...
			expected: []token.Token{
				...
				{Type: token.StringLit, Literal: "Microsoft Corporation"},
				{Type: token.EOF, Literal: ""},
			},
		},
	}
	...
	tests := []tokenTestCase{
		{
			...
			expected: []token.Token{
				...
				{Type: token.RegexLit, Literal: "/^[a-f0-9]{32}$/"},
				{Type: token.EOF, Literal: ""},
			},
		},
	}
