...
func TestUnterminatedHexPatterns(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			expect:      false,
			description: "Defers invalid hex-character validation to compilation",
		},
		{
...
func TestUnbalancedBraces(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			expect:      false,
			description: "Accepts standard meta section syntax",
		},
		{
			name:        "missing-strings-brace",
			rule:        `rule test { strings: $a = "test" condition: true }`,
			expect:      false,
			description: "Accepts standard strings section syntax",
		},
		{
...
func TestDuplicateIdentifiers(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			expect:      true,
			description: "Rejects obsolete in-rule external declaration syntax",
		},
	}
